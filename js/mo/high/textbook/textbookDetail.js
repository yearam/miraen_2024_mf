...
$(function() {
    textbookDetailScreen = {
        ...
        c: {
            ...
            getMasterInfo: async () => {
                ...
                const options = {
                    ...
                    success: async function (res) {
                        ...
                        //             } else if ($('#userGrade').val() === '002') {
                        //                 $alert.open("MG00010", () => {
                        //                     $('#popup-chapter').css('display', 'block');
                        //                 });
                        //             }
                        //         } else {
                        //             textbookDetailScreen.f.loginAlert();
                        ...
                        //                 $alert.open("MG00010", () => {
                        //
                        //                     $('#popup-type-data').css('display', 'block');
                        ...
                        $cmm.setHistoryCookie(7, 'history-high', `${depth1}:${depth2}:${depth3}:${location.pathname + location.search}`, '/pages/high');
            ...
            getRelatedTextbookList: (data) => {
                const options = {
                    ...
                    success: function (res) {
                        ...
                        console.log("연관교과 수? ", textbookListArr.length)
            ...
            getUnitListTo2Depth: async (data) => {
                ...
                try {
                    ...
                    if (unitList.length !== 0) {
                        ...
                        if (allDepth1) {
                            textbookDetailScreen.v.allDepth1 = true;
                        }
            ...
            /**
             * 유형별/단원별/중간/기말고사 카운트  - TODO: 추후 멀티다운로드 레이어 연결
             *
             * @memberOf textbookDetailScreen.c
             */
        ...
        init: async function (event) {
            ...
            if (searchParams.get('subjectCode') !== null && searchParams.get('subjectCode') !== undefined) {
                ...
                $('#gnbAreaHigh > a').addClass('active');
                $('#gnbAreaHigh > a').removeClass('active');
