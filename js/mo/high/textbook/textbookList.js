    ...
    let textbookListScreen = {
            ...
            getTextbookList: (data) => {
                const options = {
                    ...
                    success: function(res) {
                        ...
                        let $lnbInner = $(".high-list-textbook");
                        ...
                        let lnbInnerHtml = `
                            ...
                            return `<a href="/pages/high/textbook/textbookDetail.mrn?masterSeq=${item.masterSeq}&revisionCode=${item.subjectRevisionCode}&subjectCode=${item.subjectCode}" data-masterseq="${item.masterSeq}" data-revisionCode="${item.subjectRevisionCode}">
                        ...
                        // TODO - 디테일 페이지로 이동
                        $('.lnb-contents a').on('click', function (event) {
        ...
        init: function (event) {
            $(document).ready(function() {
                $('.high-list-textbook').empty();
                // $('.gnb > nav.high-nav').find('a[data-subjectId=subject0]').trigger('click');
        ...
        event: function () {
            $('.gnb > nav.high-nav > a').on("click", function () {
