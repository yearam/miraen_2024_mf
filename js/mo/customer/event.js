      ...
      setSchoolLevelItem: (levelCode) => {
        ...
        if (levels.length > 1) {
          if (eleIsFound && midIsFound && !highIsFound) {
            ...
            result = `
             <span class="badge text-elementary type-round-box size-md"><strong>초등</strong></span>
             <span class="badge text-middle type-round-box size-md"><strong>중등</strong></span>
            `
          } else if (eleIsFound && !midIsFound && highIsFound) {
            result = `
             <span class="badge text-elementary type-round-box size-md"><strong>초등</strong></span>
             <span class="badge text-high type-round-box size-md"><strong>고등</strong></span>
            `
          } else if (!eleIsFound && midIsFound && highIsFound) {
            result = `
             <span class="badge text-middle type-round-box size-md"><strong>중등</strong></span>
            ...
            result = `<span class="badge text-skyblue type-round-box size-md"><strong>공통</strong></span>`
          }
        } else {
          eleIsFound ?
            result = `<span class="badge text-elementary type-round-box size-md"><strong>초등</strong></span>`
            : midIsFound
              ? result = `<span class="badge text-middle type-round-box size-md"><strong>중등</strong></span>`
              : result = `<span class="badge text-high type-round-box size-md"><strong>고등</strong></span>`
        }
           ...
           <div class="${row.status === 'END' ? 'item end' : 'item'}">
            ...
            ${row.eventUrl ? `<a href="${row.eventUrl}" target="_blank">` : '<a>'}
              <div class="image-box">
                ...
                <div class="overlay">
                  <span class="badge fill-black type-round-box size-md">종료</span>
                </div>
