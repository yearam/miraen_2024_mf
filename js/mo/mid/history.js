    ...
    history = {
        f:{
            getHistorydata: () => {
                ...
                let result = $cmm.getCookie('history-mid');
                ...
                for (let i = 0; i < resultArr.length; i++) {
                    ...
                    if (decodeURIComponent(dataArr[3]).indexOf('pages/mid/board') >= 0 || decodeURIComponent(dataArr[3]).indexOf('pages/mid/bbs') >= 0) {
                        // 공통 게시판
                        $div.append(`
                        ...
                        `);
                    } else if (decodeURIComponent(dataArr[3]).indexOf('pages/mid/textbook') >= 0) {
                        // 교과
                        $div.append(`
                            <a href="${decodeURIComponent(dataArr[3])}">
