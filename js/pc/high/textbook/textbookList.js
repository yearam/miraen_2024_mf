                ...
                const options = {
                    ...
                    success: function(res) {
                        ...
                        if(textbookListScreen.v.sortCode == '008' && revisionCode == '2015'){
                            extraRows = [{name: '특수교육 (2022개정)', pageUrl: '/pages/high/bbs/list.mrn/TBM-ltxp1hof-mil2z3VcPg' }];
                        }
                ...
                const options = {
                    ...
                    success: function(res) {
                        ...
                        let lnbInnerHtml = `
                            ...
                            <div class="banners">
                                <a href="https://g.m-teacher.co.kr/pages/common/customer/notice.mrn/2503" target="_blank">
                                    ...
                                    <img src="/assets/images/common/img-open-banner.png" alt="2024년 신학기, 새로운 엠티처를 만나세요!" />
                                </a>
                            </div>
                ...
                const options = {
                    ...
                    success: function(res) {
                        ...
                        $('#siteMapList > li[id]').each(function() {
                            ...
                            // 24.05.02 진로/정보/특수 GNB 하단에 특수교육 추가.
                            if(this.id == 'CA|IN|EC'){
                                newData += `<a href="/pages/high/bbs/list.mrn/TBM-ltxp1hof-mil2z3VcPg" class="text-data" target="_blank">특수교육 (2022개정)</a>`;
                            }
