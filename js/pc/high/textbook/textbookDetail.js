                    ...
                    success: async function (res) {
                        ...
                        if (masterInfo.ebookUseYn === "Y" && masterInfo.ebookDisplayYn === "Y") {
                            ...
                            ebookCopyElement = `
                                ...
                                <!-- Trigger -->
                                <button data-toast="toast-copy" id="ebookLinkCopyBtn" type="button" class="button button-md type-text"  data-clipboard-target="#ebookPathInput">
                                    <svg>
                        ...
                        if (masterInfo.allSmartPptUseYn === "Y" && masterInfo.allSmartPptDisplayYn === "Y") {
                            smartPptElement = `
                             <button id="smartPptDownloadBtn" data-type="smartPptDownloadBtn" data-btn-type="page-open" data-path="${masterInfo.allSmartPptFilePath ? masterInfo.allSmartPptFilePath.replace(/ /g, "%20") : ''}" type="button" class="button size-md type-primary"> 스마트수업 
                                <svg>
                        ...
                        if (masterInfo.teacherDvdUseYn === "Y" && masterInfo.teacherDvdDisplayYn === "Y" && masterInfo.teacherDvdCount >= 1) {
                            dvdElement = `
                                <button id="dvdDownloadBtn" data-type="dvdDownloadBtn" data-btn-type="download-btn" data-count="${masterInfo.teacherDvdCount}" data-path="${masterInfo.teacherDvdFilePath ? masterInfo.teacherDvdFilePath.replace(/ /g, "%20") : ''}" type="button" class="button size-md"> 교사용 DVD 
                                  <svg>
                        ...
                        if (masterInfo.teacherTextbookUseYn === "Y" && masterInfo.teacherTextbookDisplayYn === "Y" && masterInfo.teacherbookCount >= 1) {
                            teacherTextbookElement = `
                                <button id="teacherTextbookDownloadBtn" data-type="teacherTextbookDownloadBtn" data-btn-type="download-btn" data-count="${masterInfo.teacherbookCount}" data-path="${masterInfo.teacherTextbookFilePath ? masterInfo.teacherTextbookFilePath.replace(/ /g, "%20") : ''}" type="button" class="button size-md"> 교사용 교과서 
                                  <svg>
                                    <use xlink:href="/assets/images/svg-sprite-solid.svg#icon-download"></use>
                                  </svg>
                                </button>
                        ...
                        if (masterInfo.guidebookUseYn === "Y" && masterInfo.guidebookDisplayYn === "Y" && masterInfo.guidebookCount >= 1) {
                            guidebookElement = `
                                <button id="guidebookDownloadBtn" data-type="guidebookDownloadBtn" data-btn-type="download-btn" data-count="${masterInfo.guidebookCount}" data-path="${masterInfo.guidebookFilePath ? masterInfo.guidebookFilePath.replace(/ /g, "%20") : ''}" type="button" class="button size-md"> 지도서 
                                  <svg>
                                    <use xlink:href="/assets/images/svg-sprite-solid.svg#icon-download"></use>
                                  </svg>
                                </button>
                           ...
                           <div class="textbook-intro">
                              <div class="textbook-wrap">
                                <a href="javascript:void(0);" class="book-link is-ebook" data-path="${ebookFilePath?.replace(/ /g, "%20")}" data-btn-type="page-open">
                                  ...
                                  data-btn-type="download-btn" data-path="${ebookFilePath.replace(/ /g, "%20")}"/>
                                  ${ebookUseElement}
                                </a>
                                <div class="info-box">
                                            ...
                                            <div class="hour-list">
                                                ...
                                                if (index >= 1) {
                                                    return `<a href="#" data-unitseq="${el.unitSeq}">
                                                                <span data-unitseq="${el.unitSeq}" style="${el.unitNumberName ? 'display: block' : 'display: none'}" data-unitNumberName="${el.unitNumberName ? (el.unitNumberName.includes('.') ? el.unitNumberName : el.unitNumberName + '.') : ''}">
                                                                    ${el.unitNumberName ? (el.unitNumberName.includes('.') ? el.unitNumberName : el.unitNumberName + '.') : ''}
                                                                </span>
