...
var NativeFlv = {
	...
	load: function load(settings) {
		if (typeof flvjs !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://fastly.jsdelivr.net/npm/flv.js@latest';
...
var FlvNativeRenderer = {
	...
	options: {
		prefix: 'native_flv',
		flv: {
			path: 'https://fastly.jsdelivr.net/npm/flv.js@latest',
...
var NativeHls = {
	...
	load: function load(settings) {
		if (typeof Hls !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : '/static/js/3rdparty/mediaelement/his/hls.js@latest';
...
var HlsNativeRenderer = {
	...
	options: {
		prefix: 'native_hls',
		hls: {
			path: '/static/js/3rdparty/mediaelement/his/hls.js@latest',
