...
var NativeHls = {
	...
	load: function load(settings) {
		if (typeof Hls !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://fastly.jsdelivr.net/npm/hls.js@latest';
...
var HlsNativeRenderer = {
	...
	options: {
		prefix: 'native_hls',
		hls: {
			path: 'https://fastly.jsdelivr.net/npm/hls.js@latest',
