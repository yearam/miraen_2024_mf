$(function () {
  let screen = {
    ...
    event: function () {
      ...
      $(document).on('click', 'div[data-area] .inner-header a', screen.f.fileDownloadAfterRightCheck);
      ...
      $(document).on('click', 'div[data-era] .inner-header a', screen.f.fileDownloadAfterRightCheck);
